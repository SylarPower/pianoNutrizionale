...
(async () => {
  ...
  batch.set(db.doc('organizations/demo/dietStructures/struttura-base'), { schemaVersion: 1, name: 'Struttura base Meller', status: 'active', ownerUid: nutritionist.uid, createdBy: nutritionist.uid, currentRevisionId: '1', latestChecksum: structureChecksum, ingredientCatalogVersion: 1, createdAt: now, updatedAt: now });
