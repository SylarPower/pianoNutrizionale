...
- **chat AI testuale**: pulsante fluttuante che apre una chat con l'AI; risponde solo a domande sulla webapp (piano, ricette, spesa, batch cooking, guida Meller) usando i dati dell'app senza chiamate esterne; l'unica ricerca web ammessa è quella di nuove ricette con caratteristiche richieste (es. "ricetta con pollo e riso"), con fino a 10 proposte apribili nel popup e importabili nel ricettario; le ricette importate, nuove o modificate non adattate alle grammature del dott. Meller vengono segnalate e si correggono con un click; dettatura tramite la tastiera nativa del telefono/browser, nessun microfono in-app; setup gratuito documentato in [`docs/AI_CHAT.md`](docs/AI_CHAT.md);
